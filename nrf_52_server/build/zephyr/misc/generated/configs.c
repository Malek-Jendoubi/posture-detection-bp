...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTS_CLIENT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTS_CLIENT_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_TIMEOUT, 40);
